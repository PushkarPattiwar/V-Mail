...
if choice in ['1', 'one','when','o n e','Option 1']:
    try:
        ...
        msg = MIMEMultipart()
        msg['From'] = "nahushthuse373@gmail.com"
        ...
        if attach_choice in ["yes", "yeah"]:
            ...
            file_name = listen()
            file_path = f"D:/Email-Research/Latest3/db__test/New folder/New folder/{file_name}.pdf"
        ...
        server.starttls()
        server.login("nahushthuse373@gmail.com", "qkif msxq rgda cphf")
        server.sendmail("nahushthuse373@gmail.com", receiver_email, msg.as_string())
        server.quit()
...
elif choice in ['2', 'two', 'to','Tu','2 2','Option 2. Check your inbox','Option 2','t w o']:
   # Connect to Gmail IMAP Server
    mail = imaplib.IMAP4_SSL('imap.gmail.com', 993)
    mail.login('nahushthuse373@gmail.com', 'qkif msxq rgda cphf')  # Use App Password
...
elif choice in ['3', 'three','tree','Option 3','t h r e e']:
    try:
        imap = imaplib.IMAP4_SSL("imap.gmail.com")
        imap.login('nahushthuse373@gmail.com', 'qkif msxq rgda cphf')
        imap.select("INBOX")
